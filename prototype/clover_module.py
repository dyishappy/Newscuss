...
def summarize_text_with_clover(
    article_text: str,
    cache_dir: str = None,
    ...
    """
    HyperCLOVA X SEED 3B 모델을 사용해 뉴스 기사(article_text)를
    한국어로 요약합니다.
    """
    ...
    # 3) 챗 템플릿으로 프롬프트 구성
    chat = [
        {"role": "system",    "content": "당신은 한국어 뉴스 요약에 특화된 유용한 어시스턴트입니다."},
        {"role": "user",      "content": f"다음 뉴스를 한국어로 간결하게 요약해줘:\n{article_text}"}
    ]
