...
import torch
from pretrained_module import extract_article_text, summarize_text_with_kobart, extract_keywords_from_summary, generate_discussion_topic, interactive_debate, summarize_and_print_debate_results
...
def main():
    ...
    cache_dir = "저장되어 다시 불러올 때 여기서 불러옴"
