...
import torch
from clover_module import extract_article_text, summarize_text_with_clover, extract_keywords_from_summary, generate_discussion_topic, interactive_debate, summarize_and_print_debate_results
...
def main():
    ...
    if article_text:
        summary = summarize_text_with_clover(article_text, cache_dir)
        print("\n=== 기사 요약 ===")
        print(summary)
